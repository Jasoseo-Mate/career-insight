...
urlpatterns = [
    ...
    path("company/analyze/", views.ai_analyze_company, name="ai_analyze_company"),
    ...
    path(
        "ai-matching/generate-coverletter/",
        views.ai_generate_coverletter,
        name="ai_generate_coverletter",
    ),
    path(
        "ai-matching/save-coverletter/",
