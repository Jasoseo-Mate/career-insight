...
urlpatterns = [
    ...
    path('experiences/<int:pk>/update/', views.experience_update, name='experience_update'),
    ...
    path('coverletters/create/<int:job_post_pk>/', views.coverletter_create, name='coverletter_create'),
    path('coverletters/<int:pk>/update/', views.coverletter_update, name='coverletter_update'),
    path('coverletters/<int:pk>/delete/', views.coverletter_delete, name='coverletter_delete'),
]
